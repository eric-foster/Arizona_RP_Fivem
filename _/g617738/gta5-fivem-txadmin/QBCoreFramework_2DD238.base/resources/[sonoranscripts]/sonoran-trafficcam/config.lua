...
Config.configuration_version = 2.6
...
Config.integration = {
    ...
    SpeedLimit_Display_resource = 'SpeedLimitDisplay' -- The name of the script containing the needed Speed limit export if SpeedLimit_Display_integration = true | See here for more: https://docs.sonoran.store/en/speed-camera/getting-started#needed-changes-for-speed-display.
}
